...
# %%
invalid_fights = set(self.data_aggregated[self.data_aggregated["num_fight"] < 4]["fight_id"])

# start_date = "2015-01-01"
# invalid_fights |= set(self.data_aggregated[self.data_aggregated["event_date"] < start_date]["fight_id"])
...
# %%
model = SymmetricFightNet(input_size=len(X_set), dropout_prob=0.35)
model.eval()
