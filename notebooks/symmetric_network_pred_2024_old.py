...
# %%
data[data["fighter_id"] == "41e83a89929d1327"]
# data_ag[data_ag["fighter_id"] == "41e83a89929d1327"]

# %%
round_data[round_data["fighter_id"] == "41e83a89929d1327"]

# %%
fight_data[fight_data["fighter_id"] == "41e83a89929d1327"]
...
# %%
data_ag[data_ag["UFC_names"].str.contains("Jailton Almeida")]
...
# %%
train_fights = (
    data_ag["fight_id"][data_ag["event_date"] < "2024-01-01"].unique().tolist()
)
test_fights = (
    data_ag["fight_id"][data_ag["event_date"] >= "2024-01-01"].unique().tolist()
)
...
# %%
compare_fighters_from_id("0133019a4f1055ee")

# %%
id_ = "0133019a4f1055ee"
fight = data_ag[data_ag["fight_id"] == id_].iloc[0]
f1 = fight["fighter_id"]
f2 = fight["opponent_id"]
date = fight["event_date"]
...
# %%
X1, X2, Y = from_id_to_fight("0133019a4f1055ee")
X1 = torch.reshape(X1, (1, -1))
X2 = torch.reshape(X2, (1, -1))
...
# %%
data_ag[data_ag["UFC_names"].str.contains("Almeida")].sort_values(by="event_date")

# %%
model.eval()
with torch.no_grad():
    prediction1 = model(X1, X2).detach().numpy()
    prediction2 = model(X2, X1).detach().numpy()
...
# %%
_ = data_ag
_[_["UFC_names"].str.contains("Holloway")]
