...
class DatasetWithTimeEvolution(BaseDataset):
    ...
    This class extends the BasicDataset class to include functionality for
    handling time evolution of fight data. It computes the positions of fighters
...
class ForecastDatasetTimeEvolution(ForecastDataset, DatasetWithTimeEvolution):
    ...
    X_set = DatasetWithTimeEvolution.X_set
    Xf_set = DatasetWithTimeEvolution.Xf_set
